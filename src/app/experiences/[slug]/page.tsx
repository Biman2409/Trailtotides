        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <div className="bg-[#f5f0e8] rounded-2xl p-8 border-l-4 border-[#ff6b35]">
                ...
                {adventure.operators.some((op) => op.verified) && (
                  <div className="mb-10">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <p className="text-[#ff6b35] text-xs font-semibold tracking-[0.2em] uppercase">
                          Verified Operators
                        </p>
            ...
            <div className="space-y-5 lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="bg-[#1a1f2e] rounded-2xl p-6 text-white">
                <p className="text-[#ff6b35] text-[10px] font-semibold tracking-[0.2em] uppercase mb-4">
                  At a Glance
                </p>
              ...
              <Link
                href="/plan"
                className="flex items-center justify-center gap-2 w-full bg-[#ff6b35] hover:bg-[#ff8e64] text-white font-semibold py-3.5 rounded-2xl text-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#ff6b35]/30 group"
              >
                Plan this Adventure
        ...
        <section className="bg-[#f5f0e8] py-16 lg:py-24 px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between mb-10">
              ...
              <Link
                href="/explore"
                className="hidden md:flex items-center gap-1.5 text-[#1e3d2f] text-sm font-medium hover:text-[#ff6b35] transition-colors group"
              >
                Explore all
