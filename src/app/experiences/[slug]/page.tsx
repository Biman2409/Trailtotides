          ...
          <div className="lg:col-span-2">
            ...
            <AccordionSection label="Book This Adventure" title="" defaultOpen={true}>
              <div id="operators-section" className="space-y-3">
                ...
                {/* Compare Operators — inline under other operators */}
                {allOperators.length > 1 && (
                  <div className="rounded-xl overflow-hidden" style={{ border: "1px solid var(--border-subtle)" }}>
                    <div className="px-4 py-3 flex items-center justify-between" style={{ borderBottom: "1px solid var(--border-subtle)", background: "var(--bg-surface)" }}>
                      <p className="text-[#ff5100] text-[10px] font-bold tracking-[0.22em] uppercase">Compare Operators</p>
                      <div className="flex items-center gap-3">
                        <span className="flex items-center gap-1 text-[9px] text-white/30"><span className="w-2 h-2 rounded-full inline-block" style={{ background: "#10b981" }} />Verified</span>
                        <span className="flex items-center gap-1 text-[9px] text-white/30"><span className="w-2 h-2 rounded-full inline-block" style={{ background: "rgba(255,255,255,0.18)" }} />Unverified</span>
                      </div>
                    </div>
