...
export default function ACEProfileSection({
  ...
  return (
    <section>
      ...
      >
        {/* Radar — centred, larger */}
        <div className="flex flex-col items-center pt-6 px-6 pb-4">
          <ACERadar ace={ace} userAce={userAce ?? undefined} userColor={userColor} size={280} showLabels />
        ...
        {/* Domain capability strip — only when profile exists */}
        {userAce && (
        ...
        <div className="px-6 py-5">
          {userAce ? (
            <div className="flex items-start justify-between gap-4">
              ...
              <Link
                href="/matchmaker"
                className="flex items-center gap-1.5 shrink-0 text-xs font-semibold px-3 py-2 rounded-lg transition-all hover:brightness-110"
