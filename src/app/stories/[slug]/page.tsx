  ...
  const openers: Record<string, string[]> = {
    ...
    "first-timer-on-the-rann": [
      ...
      "the-night-photi-la-tested-us": [
        ...
        ""Demchok is just 30 km from here." Demchok — India's last village on the China border. We should have turned back. Instead, we rode into thinner air and thicker uncertainty. Brake failures hit both B and me mid-descent. K and S — the pros — taught us engine braking on the spot. We reached Demchok by 3 PM. Ate at the army café. Watched steam rise from distant hot springs. Across a stream — China. Officials engaged in a flag meeting. It felt surreal. Then the sky cracked open.",
