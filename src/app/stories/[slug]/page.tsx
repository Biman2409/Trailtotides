  ...
  return (
    <div className="min-h-screen bg-[#111820]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 pb-14 w-full">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-[#f67345]/50 flex items-center justify-center text-sm font-bold text-white shadow-md shadow-[#f67345]/20">
                {story.author[0]}
              </div>
              <div>
      ...
      <article className="max-w-2xl mx-auto px-6 py-16 lg:py-24">
        {/* Lede */}
          <p className="text-white/80 text-xl lg:text-2xl font-light leading-relaxed mb-10 border-l-4 border-[#f67345] pl-6">
          {story.excerpt}
        </p>
        ...
        {/* Author card */}
          <div className="mt-10 bg-white/5 border border-white/10 rounded-2xl p-6 flex items-start gap-5">
            <div className="w-14 h-14 rounded-full bg-[#f67345]/20 flex items-center justify-center text-xl font-bold text-[#f67345] shrink-0 shadow-inner">
              {story.author[0]}
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {others.map((s) => (
              <Link key={s.id} href={`/stories/${s.slug}`} className="group block">
                ...
                <h3 className="text-white font-semibold text-base leading-snug group-hover:text-[#f67345] transition-colors mb-1">
                  {s.title}
                </h3>
