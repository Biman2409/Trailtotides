                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {["Trekking","Biking","Cycling","Mountaineering","Rock Climbing","Scrambling","Jeep Safari","Caving","Urban Adventure","Diving","Kayaking","Skiing","Snowboarding","Ice Climbing","Ice Skating"].map(t => (
