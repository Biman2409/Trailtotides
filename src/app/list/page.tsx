    ...
    <div className="min-h-screen bg-[#111820]">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 bg-[#1a1f2e] relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 50%, #c4622d22 0%, transparent 50%), radial-gradient(circle at 80% 30%, #1e3d2f30 0%, transparent 50%)",
          }}
        />
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#apply"
              className="inline-flex items-center gap-2 bg-[#c4622d] hover:bg-[#d97040] text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#c4622d]/25 group"
            >
              Apply Now
            ...
            {STEPS.map((step) => (
              <div key={step.number} className="relative">
                <div className="flex items-start gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-[#c4622d]/15 border border-[#c4622d]/25 flex items-center justify-center shrink-0">
                    <span className="text-[#c4622d] font-bold text-sm tracking-wider">{step.number}</span>
                  </div>
                  <div>
            ...
            {BENEFITS.map((benefit) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#c4622d]/15 flex items-center justify-center mb-4">
                  <benefit.icon className="w-5 h-5 text-[#c4622d]" />
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-[#1a1f2e] rounded-3xl p-8 border border-white/8">
              <div className="flex items-center gap-3 mb-6">
                <Mountain className="w-6 h-6 text-[#c4622d]" />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {submitted ? (
            <div className="bg-emerald-500/10 border border-emerald-500/25 rounded-3xl p-12 text-center">
              ...
              <Link
                href="/explore"
                className="inline-flex items-center gap-2 bg-[#c4622d] text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all hover:bg-[#d97040] hover:-translate-y-0.5 group"
              >
                Explore Adventures
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/6 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/25 text-sm focus:outline-none focus:border-[#c4622d]/60 transition-colors"
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-[#1a1f2e] border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#c4622d]/60 transition-colors"
                    >
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/6 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/25 text-sm focus:outline-none focus:border-[#c4622d]/60 transition-colors resize-none"
                    />
                  </div>
                  <div className="sm:col-span-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#c4622d] hover:bg-[#d97040] disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-xl text-base flex items-center justify-center gap-2 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#c4622d]/25 group"
              >
                {loading ? (
              ...
              <p className="text-white/30 text-xs text-center">
                ...
                <Link href="/terms" className="text-white/50 hover:text-[#c4622d] transition-colors">
                  Terms of Use
                </Link>
                .
              </p>
