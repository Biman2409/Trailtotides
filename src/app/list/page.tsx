    ...
    <div className="min-h-screen bg-[#111820]">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 bg-[#1a1f2e] relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 50%, #ff6b3522 0%, transparent 50%), radial-gradient(circle at 80% 30%, #1e3d2f30 0%, transparent 50%)",
          }}
        />
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-white/55 text-xl max-w-2xl leading-relaxed">
            Join India&apos;s most trusted adventure discovery platform. Get your experiences in front of serious adventurers — verified, mapped, and AI-recommended.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#apply"
              className="inline-flex items-center gap-2 bg-[#ff6b35] hover:bg-[#ff8e64] text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#ff6b35]/25 group"
            >
              Apply Now
      ...
      <section className="py-20 lg:py-28 px-6 lg:px-8 bg-[#111820]">
        <div className="max-w-7xl mx-auto">
          <p className="text-[#ff6b35] text-xs font-semibold tracking-[0.22em] uppercase mb-3">
            The Process
          </p>
            ...
            {STEPS.map((step) => (
              <div key={step.number} className="relative">
                <div className="flex items-start gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-[#ff6b35]/15 border border-[#ff6b35]/25 flex items-center justify-center shrink-0">
                    <span className="text-[#ff6b35] font-bold text-sm tracking-wider">{step.number}</span>
                  </div>
                  <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {BENEFITS.map((benefit) => (
              <div
                key={benefit.title}
                className="bg-white/4 border border-white/8 rounded-2xl p-6 hover:border-[#ff6b35]/30 hover:bg-white/6 transition-all duration-300"
              >
                <div className="w-10 h-10 rounded-xl bg-[#ff6b35]/15 flex items-center justify-center mb-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {submitted ? (
            <div className="bg-emerald-500/10 border border-emerald-500/25 rounded-3xl p-12 text-center">
              ...
              <Link
                href="/explore"
                className="inline-flex items-center gap-2 bg-[#ff6b35] text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all hover:bg-[#ff8e64] hover:-translate-y-0.5 group"
              >
                Explore Adventures
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/6 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/25 text-sm focus:outline-none focus:border-[#ff6b35]/60 transition-colors"
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/6 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/25 text-sm focus:outline-none focus:border-[#ff6b35]/60 transition-colors resize-none"
                    />
                  </div>
                  <div className="sm:col-span-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#ff6b35] hover:bg-[#ff8e64] disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-xl text-base flex items-center justify-center gap-2 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#ff6b35]/25 group"
              >
                {loading ? (
              ...
              <p className="text-white/30 text-xs text-center">
                ...
                <Link href="/terms" className="text-white/50 hover:text-[#ff6b35] transition-colors">
                  Terms of Use
                </Link>
                .
              </p>
