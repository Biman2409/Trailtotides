        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-8 lg:px-20 xl:px-32 bg-[#0a0a0a] relative overflow-y-auto lg:overflow-hidden">
          ...
          <div className="max-w-md w-full mx-auto relative z-10">
            ...
            <Link href="/" className="flex items-center gap-2 mb-6 lg:hidden">
              <div className="w-8 h-8 bg-[#f67345] rounded-lg flex items-center justify-center">
            ...
            {message && (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-5 py-3.5 text-white text-sm placeholder-white/20 focus:outline-none focus:border-[#f67345]/50 focus:bg-white/[0.06] transition-all"
                />
              </div>
              ...
              <div className="flex gap-2">
                <div className="relative">
                  <select
                    name="country_code"
                    defaultValue="+91"
                    className="h-full bg-white/[0.03] border border-white/10 rounded-2xl pl-5 pr-10 py-3.5 text-white text-sm focus:outline-none focus:border-[#f67345]/50 focus:bg-white/[0.06] transition-all appearance-none cursor-pointer min-w-[100px]"
                  >
                    {[
                ...
                <input
                  ...
                  className="flex-1 bg-white/[0.03] border border-white/10 rounded-2xl px-5 py-3.5 text-white text-sm placeholder-white/20 focus:outline-none focus:border-[#f67345]/50 focus:bg-white/[0.06] transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  minLength={6}
                  placeholder="••••••••"
                  className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-5 py-3.5 pr-14 text-white text-sm placeholder-white/20 focus:outline-none focus:border-[#f67345]/50 focus:bg-white/[0.06] transition-all"
                />
                <button
                  type="button"
            ...
            <div className="flex items-start gap-3 py-2">
              <div className="flex items-center h-5 mt-0.5">
                <input
                  ...
                  type="checkbox"
                  required
                  className="w-4 h-4 rounded-lg border-white/10 bg-white/5 text-[#f67345] focus:ring-[#f67345]/20 transition-all cursor-pointer"
                />
              </div>
              <label htmlFor="terms" className="text-[11px] text-white/40 leading-snug cursor-pointer font-medium">
                I agree to the{" "}
                <Link href="/terms" className="text-[#f67345]/70 hover:text-[#f67345] transition-colors underline underline-offset-2">Terms</Link>
                {" "}and{" "}
                <Link href="/privacy" className="text-[#f67345]/70 hover:text-[#f67345] transition-colors underline underline-offset-2">Privacy Policy</Link>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#f67345] hover:bg-[#f88c64] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-2xl py-4 transition-all hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#f67345]/20 text-sm mt-2"
            >
          ...
          <p className="mt-8 text-center text-white/30 text-xs font-medium">
            ...
            <Link href="/auth/login" className="text-[#f67345] hover:text-[#f88c64] font-bold transition-colors">
              Log in
            </Link>
          </p>
        </div>
