  ...
  return (
    <div className="max-w-md w-full mx-auto">
      ...
      <Link href="/" className="flex items-center gap-2 mb-6 lg:hidden">
        <Mountain className="w-8 h-8 text-[#f4845f]" />
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-5 py-4 text-white placeholder-white/20 focus:outline-none focus:border-[#f4845f]/50 focus:bg-white/[0.06] transition-all"
          />
        </div>
        ...
        <div>
            <div className="flex justify-between items-center mb-2 ml-1">
              ...
              <Link href="/auth/forgot-password" className="text-[10px] font-bold text-[#f4845f]/60 hover:text-[#f4845f] transition-colors uppercase tracking-widest">
                Forgot?
              </Link>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#f4845f] hover:bg-[#f69d7c] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-2xl py-4 transition-all hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#f4845f]/20 mt-2"
          >
      ...
      <p className="mt-8 text-center text-white/30 text-sm font-medium">
        ...
        <Link href="/auth/signup" className="text-[#f4845f] hover:text-[#f69d7c] font-bold transition-colors">
          Create account
        </Link>
      </p>
    </div>
