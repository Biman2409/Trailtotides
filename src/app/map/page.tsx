                ...
                <div className="col-span-2 lg:col-span-3">
                  ...
                  {(() => {
                    const regionGroups: { name: Region; icon: React.ReactNode; btn: string; btnActive: string; chip: string; chipActive: string; subRegions: string[] }[] = [
                      { name: "Himalayas",     btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100", btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]", chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200", chipActive: "bg-[#ff6b35] text-white", subRegions: ["Ladakh", "Jammu & Kashmir", "Uttarakhand", "Himachal Pradesh", "Sikkim", "Arunachal Pradesh", "Nepal", "Bhutan"] },
                      { name: "Western Ghats", btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",             btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]",     chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",         chipActive: "bg-[#ff6b35] text-white",     subRegions: ["Kerala", "Karnataka", "Goa", "Maharashtra", "Gujarat"] },
                      { name: "Eastern Ghats", btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",     btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]", chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",   chipActive: "bg-[#ff6b35] text-white",   subRegions: ["Odisha", "Andhra Pradesh", "Telangana", "Tamil Nadu"] },
                      { name: "Desert",        btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",     btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]", chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",   chipActive: "bg-[#ff6b35] text-white",   subRegions: ["Rajasthan", "Gujarat"] },
                      { name: "Coast",         btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",             btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]",     chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",         chipActive: "bg-[#ff6b35] text-white",     subRegions: ["Maharashtra (Konkan)", "Goa", "Kerala", "Karnataka", "Odisha", "Tamil Nadu", "Andhra Pradesh"] },
                      { name: "Islands",       btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",             btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]",     chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",         chipActive: "bg-[#ff6b35] text-white",     subRegions: ["Andaman & Nicobar", "Lakshadweep"] },
                        { name: "Northeast",     btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",     btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]", chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",   chipActive: "bg-[#ff6b35] text-white",   subRegions: ["Nagaland", "Manipur", "Meghalaya", "Assam", "Arunachal Pradesh", "Sikkim"] },
                        { name: "Urban",         btn: "bg-zinc-50 border-zinc-200 text-zinc-700 hover:bg-zinc-100",               btnActive: "bg-[#ff6b35] text-white border-[#ff6b35]",     chip: "bg-zinc-100 text-zinc-700 hover:bg-zinc-200",         chipActive: "bg-[#ff6b35] text-white",     subRegions: ["Mumbai", "Delhi", "Bangalore", "Chennai", "Kolkata", "Hyderabad", "Pune"] },
                      ];
                    return (
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-wrap gap-2">
