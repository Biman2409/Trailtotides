...
const RANKS = [
  {
    ...
    // Badge: plain circle + upward arrow — minimal, beginner
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
        <circle cx="10" cy="10" r="7.5" stroke="currentColor" strokeWidth="1.4"/>
        <path d="M10 13.5V7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M7.5 9.5L10 7l2.5 2.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    ...
    // Badge: shield + 3 waypoint dots forming a trail
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
        <path d="M10 2L16.5 5V10.5C16.5 14.2 13.5 17 10 18.2C6.5 17 3.5 14.2 3.5 10.5V5L10 2Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
  ...
  },
  {
    ...
    // Badge: hexagon + compass diamond with filled tip
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
        <path d="M10 1.5L17 5.5V13.5L10 18L3 13.5V5.5L10 1.5Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
        <path d="M10 5.5L12.5 10L10 14.5L7.5 10L10 5.5Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" fill="currentColor" fillOpacity="0.2"/>
        <path d="M10 5.5L12.5 10L10 8.5L7.5 10L10 5.5Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
    ...
    // Badge: pointed shield with crown notch at top + mountain silhouette inside
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
        <path d="M10 1.5L3 5V11C3 14.8 6 17.5 10 19C14 17.5 17 14.8 17 11V5L10 1.5Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
        <path d="M7.5 1.5L10 3.5L12.5 1.5" stroke="currentColor" strokeWidth="1.1" strokeLinejoin="round" strokeOpacity="0.6"/>
        <path d="M5.5 15L8 10.5L10 13L12 8.5L15 15H5.5Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" fill="currentColor" fillOpacity="0.25"/>
      </svg>
    ),
  },
  {
    ...
    // Badge: 5-point star outer shape + solid star fill inside
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
        <polygon points="10,1.5 12.9,7.8 19.5,8.1 14.7,12.8 16.3,19.2 10,15.8 3.7,19.2 5.3,12.8 0.5,8.1 7.1,7.8" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" fill="currentColor" fillOpacity="0.12"/>
        <polygon points="10,5.5 11.4,9.2 15.3,9.5 12.4,12 13.4,15.8 10,13.7 6.6,15.8 7.6,12 4.7,9.5 8.6,9.2" fill="currentColor" fillOpacity="0.7"/>
      </svg>
    ),
  },
];
