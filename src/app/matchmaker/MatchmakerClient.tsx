...
const QUESTIONS = [
  {
    ...
    question: "In a full day outdoors, how many hours can you walk or trek comfortably?",
    hint: "Think of a long hike or any steady activity on consecutive days.",
    options: [
      { v: "A", l: "1–2 hours" },
      { v: "B", l: "2–4 hours" },
      { v: "C", l: "4–6 hours" },
      { v: "D", l: "6–8 hours" },
      { v: "E", l: "8–12+ hours, even on back-to-back days" },
    ],
  },
  {
    key: "Q2",
    ...
    question: "What backpack weight can you comfortably carry for a full day?",
    hint: "Think of a loaded pack on a multi-day trek.",
    options: [
      { v: "A", l: "Almost nothing (under 5 kg)" },
      { v: "B", l: "Light (5–8 kg)" },
      { v: "C", l: "Moderate (8–12 kg)" },
      { v: "D", l: "Heavy (12–15 kg)" },
      { v: "E", l: "Very heavy (15+ kg)" },
    ],
  },
  {
    key: "Q3",
    ...
    question: "How do you handle long or repeated steep climbs?",
    hint: "Think of sustained uphill sections across a full day.",
    options: [
      { v: "A", l: "I avoid steep climbs" },
      { v: "B", l: "I can manage short climbs" },
      { v: "C", l: "I can handle steady uphill sections" },
      { v: "D", l: "I can push through long or repeated climbs" },
      { v: "E", l: "I can sustain steep climbs for extended periods" },
    ],
  },
  {
    key: "Q4",
    ...
    question: "What kind of terrain are you comfortable moving through?",
    hint: "Be honest — this directly affects your safety.",
    options: [
      { v: "A", l: "Flat, stable paths" },
      { v: "B", l: "Uneven trails (mud, roots)" },
      { v: "C", l: "Rocky or loose terrain, stream crossings" },
      { v: "D", l: "Narrow paths, scrambling using hands" },
      { v: "E", l: "Ice, glaciers, or highly unstable ground" },
    ],
  },
  {
    key: "Q5",
    ...
    question: "How confident are you in water during outdoor activities?",
    hint: "Open water, rivers, sea — not just a calm pool.",
    options: [
      { v: "A", l: "I'm not comfortable being in water" },
      { v: "B", l: "I'm okay in calm, shallow water" },
      { v: "C", l: "I'm comfortable in deeper water and can swim" },
      { v: "D", l: "I'm confident in strong currents or rough water (with gear or support)" },
      { v: "E", l: "I'm fully confident in deep, fast-moving, or unpredictable water" },
    ],
  },
  {
    key: "Q6",
    ...
    question: "What is the highest altitude you've comfortably stayed overnight?",
  ...
  },
  {
    ...
    options: [
      { v: "A", l: "I avoid these situations" },
      { v: "B", l: "I'm okay if it feels safe and short" },
      { v: "C", l: "I can manage with caution and breaks" },
      { v: "D", l: "I stay steady and focused even when it's long or exposed" },
      { v: "E", l: "I stay calm, sharp, and in control even in extreme exposure" },
    ],
  },
  {
    key: "Q8",
    ...
    options: [
      { v: "A", l: "I feel uncomfortable without quick help nearby" },
      { v: "B", l: "I'm okay if it's a short duration" },
      { v: "C", l: "I can manage a day in remote settings" },
      { v: "D", l: "I'm comfortable being remote for extended periods" },
      { v: "E", l: "I'm fully at ease operating in isolated, no-support environments" },
    ],
  },
];
