  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
        ...
        <circle cx="14.5" cy="17.5" r="1.6" fill="currentColor"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
        <path d="M12 2L21.5 7.5V16.5L12 22L2.5 16.5V7.5L12 2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" fill="currentColor" fillOpacity="0.1"/>
        <path d="M12 6.5L15.5 12L12 17.5L8.5 12L12 6.5Z" fill="currentColor" fillOpacity="0.25" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>
        <path d="M12 6.5L15.5 12L12 11L8.5 12L12 6.5Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
        <path d="M12 2L4 6.5V13.5C4 18.5 7.5 22.2 12 23.5C16.5 22.2 20 18.5 20 13.5V6.5L12 2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" fill="currentColor" fillOpacity="0.1"/>
        <path d="M9 2L12 4.5L15 2" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" strokeOpacity="0.65"/>
        <path d="M6.5 19L9.5 13L12 16L14.5 10.5L18 19H6.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" fill="currentColor" fillOpacity="0.35"/>
      </svg>
    ),
  },
  {
  ...
  return (
    <div className="w-full space-y-5">
      ...
      <div className="relative pt-1 pb-2">
        {/* Track background — runs between first and last marker centres */}
