    ...
    <div className="min-h-screen bg-[#111820]">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
            ...
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-5 py-2 mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-[#ff5722] mr-2.5 animate-pulse" />
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/explore"
                className="bg-[#ff5722] hover:bg-[#ff7043] text-white font-semibold px-8 py-4 rounded-xl text-base flex items-center gap-2 group shadow-xl shadow-black/30 min-w-[200px] justify-center hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-[#ff5722]/40 transition-all duration-200"
              >
                Explore Adventures
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-8 bg-[#0e1420] border-t border-white/6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 flex justify-center md:hidden">
            <Link
              href="/stories"
              className="flex items-center gap-1.5 text-[#ff5722] font-semibold text-sm"
            >
      ...
      <section className="relative py-24 lg:py-32 bg-[#141920] border-t border-white/6 px-6 lg:px-8 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 15% 50%, #ff572222 0%, transparent 55%), radial-gradient(circle at 85% 50%, #1a2e2018 0%, transparent 55%)",
          }}
        />
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, #ff5722 0, #ff5722 1px, transparent 0, transparent 50%)",
        ...
        />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/explore"
              className="bg-[#ff5722] hover:bg-[#ff7043] text-white font-semibold px-9 py-4 rounded-xl text-base flex items-center gap-2 group shadow-lg shadow-[#ff5722]/20 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#ff5722]/30 transition-all duration-200"
            >
              Start Exploring
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
