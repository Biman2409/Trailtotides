    ...
    <div className="min-h-screen bg-[#111820]">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
            ...
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-5 py-2 mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-[#ff6b35] mr-2.5 animate-pulse" />
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/explore"
                className="bg-[#ff6b35] hover:bg-[#ff8e64] text-white font-semibold px-8 py-4 rounded-xl text-base flex items-center gap-2 group shadow-xl shadow-black/30 min-w-[200px] justify-center hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-[#ff6b35]/40 transition-all duration-200"
              >
                Explore Adventures
      ...
      <section id="featured-adventures" className="py-24 lg:py-32 px-6 lg:px-8 bg-[#111820]">
          <div className="max-w-7xl mx-auto">
            <div className="mb-14">
              ...
              <div className="flex items-end justify-between gap-4">
                ...
                <span className="hidden sm:flex items-center gap-1.5 text-[#ff6b35] text-sm font-semibold bg-[#ff6b35]/8 border border-[#ff6b35]/20 px-3 py-1.5 rounded-full mb-1">
          ...
          <div className="mt-14 flex justify-center">
            <Link
              href="/explore"
              className="bg-[#ff6b35] hover:bg-[#ff8e64] text-white font-semibold px-9 py-4 rounded-xl text-base flex items-center gap-2 group shadow-lg shadow-[#ff6b35]/25 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#ff6b35]/30 transition-all duration-200"
            >
              View all adventures
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-8 bg-[#0e1420] border-t border-white/6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link
              href="/stories"
              className="hidden md:flex items-center gap-1.5 text-white/50 font-semibold hover:text-[#ff6b35] transition-colors group text-sm"
            >
              All stories
      ...
      <section className="relative py-24 lg:py-32 bg-[#141920] border-t border-white/6 px-6 lg:px-8 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 15% 50%, #ff6b3522 0%, transparent 55%), radial-gradient(circle at 85% 50%, #1a2e2018 0%, transparent 55%)",
          }}
        />
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, #ff6b35 0, #ff6b35 1px, transparent 0, transparent 50%)",
        ...
        />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/explore"
              className="bg-[#ff6b35] hover:bg-[#ff8e64] text-white font-semibold px-9 py-4 rounded-xl text-base flex items-center gap-2 group shadow-lg shadow-[#ff6b35]/20 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#ff6b35]/30 transition-all duration-200"
            >
              Start Exploring
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
