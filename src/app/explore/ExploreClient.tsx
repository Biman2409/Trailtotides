...
import { Search, SlidersHorizontal, X, ChevronDown, Map as MapIcon, ArrowRight, Compass, Send, ChevronRight, Loader2, Wind, Sun, Mountain, Waves, Snowflake, Trees, Palmtree, Sunrise, Building2, Flower2, CloudRain, Leaf, Footprints, Bike, Car, HardHat, Ship, Zap, Activity, ShieldAlert, Trophy, Flame, Calendar, CalendarRange, History } from "lucide-react";
...
const difficultyColor: Record<string, string> = {
  Beginner: "#22c55e", Intermediate: "#3b82f6", Advanced: "#ff8e64",
