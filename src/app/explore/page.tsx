...
export const metadata: Metadata = {
  ...
  description:
    "Browse and filter 100+ handpicked adventures across India — trekking, biking, diving, climbing, kayaking, and more. Filter by region, difficulty, duration, and season.",
  openGraph: {
    title: "Explore Adventures — Trail to Tides",
    description:
      "Browse and filter 100+ handpicked adventures across India — trekking, biking, diving, climbing, kayaking, and more.",
