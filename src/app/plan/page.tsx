        ...
        {step === "preferences" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-10">
                    ...
                    <button
                      ...
                      className={`relative overflow-hidden rounded-xl h-20 border-2 transition-all ${
                        selectedRegions.includes(r.name as Region)
                          ? "border-[#c4622d] shadow-lg shadow-[#c4622d]/20"
                          : "border-transparent"
                      }`}
                    >
                      ...
                      {selectedRegions.includes(r.name as Region) && (
                        <div className="absolute inset-0 bg-[#c4622d]/30" />
                      )}
                      <div className="relative z-10 h-full flex flex-col items-center justify-center gap-0.5">
                        ...
                        {selectedRegions.includes(r.name as Region) && (
                          <CheckCircle2 className="w-3.5 h-3.5 text-[#f09060]" />
                        )}
                      </div>
                    </button>
                  ))}
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-sm font-medium border transition-all ${
                        selectedTypes.includes(t)
                          ...
                          : "bg-white border-[#e0d8cc] text-[#1a1f2e] hover:border-[#c4622d]/40"
                      }`}
                    >
                      {t}
                    </button>
              ...
              <section>
                <div className="flex items-center gap-2 mb-5">
                  <TrendingUp className="w-5 h-5 text-[#c4622d]" />
                ...
                <div className="flex flex-wrap gap-2">
                  {([
                    ...
                    { val: "Expert" as Difficulty,       color: "bg-orange-500 text-white border-orange-500",      idle: "bg-orange-50 text-orange-800 border-orange-200" },
              ...
              <button
                onClick={handlePlan}
                className="w-full bg-[#c4622d] hover:bg-[#d97040] text-white font-semibold py-4 rounded-xl text-base flex items-center justify-center gap-2 group transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#c4622d]/25"
              >
            ...
            <div className="hidden lg:block">
              <div className="sticky top-28 space-y-5">
                <div className="bg-[#1a1f2e] rounded-2xl p-6">
                  <p className="text-[#c4622d] text-xs font-semibold tracking-widest uppercase mb-4">Tips</p>
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-2.5">
                        <ChevronRight className="w-4 h-4 text-[#c4622d] shrink-0 mt-0.5" />
                ...
                <div className="bg-[#c4622d]/10 border border-[#c4622d]/20 rounded-2xl p-5">
                  <div className="flex items-center gap-2 mb-2">
                    <Sparkles className="w-4 h-4 text-[#c4622d]" />
                    <span className="text-[#c4622d] text-xs font-semibold uppercase tracking-wider">AI Finder</span>
                  </div>
                  <p className="text-white/55 text-sm leading-relaxed mb-3">
                    Prefer to just describe what you want? Use Compass AI on the home page.
                  </p>
                  <Link href="/#ai-finder" className="text-[#c4622d] text-xs font-semibold hover:text-[#e07845] transition-colors flex items-center gap-1">
          ...
          <div>
                  ...
                  <Link key={a.id} href={`/experiences/${a.slug}`} className="group block">
                    <div className="relative h-[300px] overflow-hidden rounded-2xl bg-[#1a1f2e] shadow-md hover:shadow-xl hover:shadow-black/20 transition-shadow duration-300">
                      ...
                      <div className="absolute top-4 left-4 right-4 flex items-start justify-between">
                        <span className="bg-[#c4622d] text-white text-xs font-semibold px-3 py-1.5 rounded-full">{a.type}</span>
                        <span className={`text-xs font-semibold px-3 py-1.5 rounded-full ${
                          ...
                          a.difficulty === "Expert" ? "bg-orange-500 text-white" :
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-5">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#c4622d] transition-colors">
            ...
            {matched.length > 0 && (
              <div className="mt-12 text-center">
                <Link
                  href="/explore"
                  className="inline-flex items-center gap-2 text-[#c4622d] font-semibold text-sm hover:text-[#e07845] transition-colors group"
                >
