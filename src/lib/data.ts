...
export const adventures: Adventure[] = [
  ...
  },
  {
      ...
      },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹9800", rating: 4.8, website: "https://trekthehimalayas.com/ali-bedni-bugyal-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
      ...
      slug: "gulabi-kantha",
      name: "Gulabi Kantha",
      tagline: "Gulabi Kantha in Uttarakhand",
      region: "Himalayas",
      state: "Uttarakhand",
      type: "Trekking",
      difficulty: "Intermediate",
      duration: "3–5 days",
      durationDays: "5 Days",
      terrain: "High altitude trek starting from Hanuman Chatti",
      bestSeason: "All year",
      bestMonths: [],
      groupSize: "Small group (2–6)",
      heroImage: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=70",
      ...
      lat: 0,
      lng: 0,
      description: "Gulabi Kantha is a Moderate trek in Uttarakhand spanning 24 km.",
      whatMakesSpecial: "Spectacular views of the Uttarakhand mountains.",
      whoFor: "Trekkers looking for a intermediate challenge.",
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹10900", rating: 4.8, website: "https://trekthehimalayas.com/gulabi-kantha-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹5500", rating: 4.8, website: "https://trekthehimalayas.com/kareri-lake-trek" }],
      tags: ["trekking", "himachal pradesh", "beginner"],
      featured: false,
    },
    {
      id: "117",
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹17000", rating: 4.8, website: "https://trekthehimalayas.com/tarsar-marsar-trek" }],
      tags: ["trekking", "kashmir", "intermediate"],
      featured: false,
    },
    {
      id: "118",
      ...
      durationDays: "7 Days",
      terrain: "High altitude trek starting from Sepi",
      bestSeason: "All year except monsoon",
      bestMonths: [],
      groupSize: "Small group (2–6)",
      heroImage: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=70",
      galleryImages: [],
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹13900", rating: 4.8, website: "https://trekthehimalayas.com/sandakphu-trek" }],
      tags: ["trekking", "west bengal", "intermediate"],
      featured: false,
    },
    {
      ...
      lat: 0,
      lng: 0,
      description: "Bajre Dara is a Moderate trek in Sikkim spanning 22 km.",
      whatMakesSpecial: "Spectacular views of the Sikkim mountains.",
      whoFor: "Trekkers looking for a intermediate challenge.",
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
    ...
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹-", rating: 4.8, website: "https://trekthehimalayas.com/roopkund-trek" }],
      tags: ["trekking", "uttarakhand", "advanced"],
      featured: false,
    },
      {
