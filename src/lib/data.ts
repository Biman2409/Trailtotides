      ...
      },
{
      ...
      },
  {
    ...
    tagline: "Chadar Trek (Frozen River) in Ladakh",
    region: "Himalayas",
    state: "Ladakh",
    type: "Trekking",
    difficulty: "Expert",
    ...
    lat: 0,
    lng: 0,
    description: "Chadar Trek (Frozen River) is a Difficult trek in Ladakh spanning 28 km.",
    whatMakesSpecial: "Spectacular views of the Ladakh mountains.",
    whoFor: "Trekkers looking for a expert challenge.",
    whoNot: "Those not physically fit for high altitude.",
    safetyNotes: "Carry high altitude gear and follow guide instructions.",
    operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹26500", rating: 4.8, website: "https://trekthehimalayas.com/chadar-trek" }],
    tags: ["trekking", "ladakh", "expert"],
    featured: false,
  },
  {
    id: "115",
