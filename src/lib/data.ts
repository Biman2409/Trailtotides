  ...
  },
{
  ...
  },
  {
    ...
    tagline: "Himachal's most accessible 5,000m summit — a true high-altitude mountaineering debut",
    region: "Himalayas",
    state: "Himachal Pradesh",
    type: "Mountaineering",
    difficulty: "Advanced",
    ...
    groupSize: "Small group (2–6)",
    baseCamp: "Solang Valley (2,480m)",
    heroImage: "https://images.unsplash.com/photo-1533130061792-64b345e4a833?w=1400&q=80",
    galleryImages: [
    ...
    lat: 32.2396,
    lng: 77.1887,
    description: "Friendship Peak (5,289m) sits above the Solang Valley near Manali and is widely regarded as the ideal first technical peak for mountaineers in India. The climb involves glacier travel, fixed-rope sections, and a short but committing summit push — all the skills of high-altitude mountaineering without the extreme commitment of a 6,000m objective. The approach through Dhundi and up to the base camp passes through dense Himalayan forest and open moraines, with the Beas Kund glacier coming into view on day two. Summit day reveals panoramic views across the Kullu-Manali valley to the Pir Panjal range and on clear days as far as the Spiti watershed.",
    whatMakesSpecial: "Friendship Peak is the perfect bridge between trekking and serious mountaineering. The technical sections are real — crampon work, ice axe arrest, rope management on steep snow — but they're achievable for a fit person with proper training. The summit view at dawn, with Hanuman Tibba and Deo Tibba looming above the Manali valley, is an image that stays with you permanently.",
    whoFor: "Trekkers ready for their first technical climb. Physically strong hikers with good high-altitude experience. Anyone who wants to understand what real mountaineering feels like before committing to a 6,000m peak.",
    whoNot: "First-timers to high altitude with no prior trek experience. Anyone not prepared to use crampons and ice axes. Those unwilling to do pre-expedition fitness training for at least 6–8 weeks.",
    safetyNotes: "Acclimatisation is critical — spend at least 2 nights in Manali (2,050m) before the approach. All climbers must have basic crampon and ice axe training before summit day; reputable operators provide this at base camp. Weather windows in May can close fast — build buffer days into your itinerary and never summit in deteriorating conditions.",
    operators: [
      { name: "Himalayan Adventure Institute", verified: true, priceFrom: "₹22,000", rating: 4.8, website: "https://himalayanadventureinstitute.com" },
      { name: "Adventuro Manali", verified: true, priceFrom: "₹19,500", rating: 4.7, website: "https://adventuromanali.com" },
      { name: "Snow Leopard Adventures", verified: false, priceFrom: "₹17,000", rating: 4.3, website: "https://snowleopardadventures.in" },
    ],
    tags: ["mountaineering", "5000m", "glacier", "Manali", "first peak", "Himachal"],
    featured: false,
    seedReviews: [
      { id: "sr-fp-1", username: "ishaan_climbs", rating: 5, body: "My first proper mountaineering summit and it completely changed how I think about the mountains. The glacier section at 4am by headlamp, the crampons biting into hard snow, the rope going taut between you and your partner — nothing in trekking prepares you for that feeling. Himalayan Adventure Institute were excellent throughout.", created_at: "2025-05-28T06:00:00Z", user_id: "" },
      { id: "sr-fp-2", username: "kavya_altitude", rating: 5, body: "Came here after two Himalayan treks and this was a completely different challenge. The technical training at base camp (crampon technique, self-arrest) is genuinely well run — you feel prepared by the time summit day arrives. Views from the top are unreal: Hanuman Tibba, Deo Tibba, Rohtang all at once.", created_at: "2025-06-10T08:30:00Z", user_id: "" },
      { id: "sr-fp-3", username: "rohan_peaks", rating: 4, body: "Summit day was tough — left BC at 2am, reached top around 8:30am. Wind was brutal on the final ridge but the guide called it correctly and we pushed through. Lost feeling in two fingers briefly but fine within an hour. Worth every bit of discomfort. Would strongly recommend this as a stepping stone before attempting Stok Kangri or anything higher.", created_at: "2025-05-20T14:00:00Z", user_id: "" },
    ],
  },
  {
    id: "15",
    slug: "roopkund-trek",
    name: "Roopkund Trek",
    tagline: "The mystery lake at 5,029m — surrounded by ancient skeletal remains and Himalayan silence",
    region: "Himalayas",
    state: "Uttarakhand",
    type: "Trekking",
    difficulty: "Advanced",
    ...
    lat: 30.2495,
    lng: 79.7307,
    description: "Roopkund is one of India's most storied treks — a glacial lake at 5,029m in the Garhwal Himalayas whose shores are littered with the skeletal remains of over 300 people, dating back to the 9th century. Scientists believe they perished in a sudden hailstorm. The trek itself is a journey through some of Uttarakhand's most varied terrain: oak and rhododendron forests, high-altitude meadows at Ali Bugyal and Bedni Bugyal, exposed ridgelines with views of Trishul (7,120m) and Nanda Ghunti (6,309m), and a final push through snow and ice to the haunting lake at the top.",
    whatMakesSpecial: "No other trek in India combines genuine high-altitude challenge, archaeological mystery, and sheer scenic scale in the same package. The bugyals (alpine meadows) in May are covered in wildflowers stretching to the horizon. The final approach to the lake — crampons on, wind howling — is a different world entirely. And then the lake itself: still, dark, and surrounded by bones.",
    whoFor: "Experienced trekkers comfortable at altitude above 4,000m. Anyone drawn to offbeat history and mystery alongside physical challenge. Those who want a true taste of technical conditions without full mountaineering commitment.",
    whoNot: "First-time trekkers or those without any prior Himalayan experience. People with respiratory or cardiac conditions. Anyone who underestimates the snow and ice on the final day.",
    safetyNotes: "The final stretch to the lake requires crampons and trekking poles — these are non-negotiable in most conditions. AMS risk is real at 5,000m; follow a proper acclimatisation schedule and descend immediately if symptoms appear. Carry a pulse oximeter. The trail can be completely different in character between May and October — confirm current conditions with your operator before departure.",
    operators: [
      { name: "Indiahikes", verified: true, priceFrom: "₹14,200", rating: 4.9, website: "https://indiahikes.com" },
      { name: "Trek The Himalayas", verified: true, priceFrom: "₹12,500", rating: 4.7, website: "https://trekthehimalayas.com" },
      { name: "The Wanderers India", verified: false, priceFrom: "₹10,500", rating: 4.2, website: "https://thewanderersindia.com" },
    ],
    tags: ["mystery lake", "skeletons", "Uttarakhand", "bugyals", "Trishul", "high altitude"],
    featured: false,
    seedReviews: [
      { id: "sr-rpk-1", username: "anika_wanders", rating: 5, body: "Ali Bugyal on a clear morning with Trishul filling the sky is simply one of the most beautiful things I've ever seen. The lake is eerie and spectacular in equal measure — the bones are real and it makes you stop and think in a way that no museum ever could. This trek has everything.", created_at: "2025-05-22T07:00:00Z", user_id: "" },
      { id: "sr-rpk-2", username: "siddharth_trek", rating: 5, body: "Third Himalayan trek and by far the most dramatic. The jump from the meadows to the snow line happens almost overnight — day four you're in flowers and by day six you're on crampons. Indiahikes run an incredibly tight operation; the safety briefings and AMS monitoring are the best I've seen.", created_at: "2025-10-04T10:00:00Z", user_id: "" },
      { id: "sr-rpk-3", username: "pooja_h", rating: 4, body: "The legend of the lake makes every step more interesting. Reached the rim at sunrise and had it completely to ourselves for 20 minutes before the next group arrived. Do it in October for stable weather and fewer people. The descent on loose scree with tired legs is not fun — poles are essential.", created_at: "2025-10-12T09:15:00Z", user_id: "" },
    ],
  }
];
