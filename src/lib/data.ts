...
export const adventures: Adventure[] = [
  ...
  },
  {
      ...
      },
    {
      ...
      bestSeason: "March to April | September to November",
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹21000", rating: 4.8, website: "https://trekthehimalayas.com/goechala-trek" }],
    ...
    },
    {
      ...
      bestSeason: "All year except July-August",
      bestMonths: ["Jul", "Aug"],
      groupSize: "Small group (2–6)",
      heroImage: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=70",
      galleryImages: [],
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹-", rating: 4.8, website: "https://trekthehimalayas.com/dayara-bugyal-trek" }],
    ...
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹8900", rating: 4.8, website: "https://trekthehimalayas.com/chopta-chandrashila-deoria-tal-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹10900", rating: 4.8, website: "https://trekthehimalayas.com/kedarkantha-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹10900", rating: 4.8, website: "https://trekthehimalayas.com/brahmatal-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹11800", rating: 4.8, website: "https://trekthehimalayas.com/valley-of-flowers-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
      ...
      whoNot: "Those not physically fit for high altitude.",
      safetyNotes: "Carry high altitude gear and follow guide instructions.",
      operators: [{ name: "Trek The Himalayas", verified: true, priceFrom: "₹11900", rating: 4.8, website: "https://trekthehimalayas.com/winter-kuari-pass-trek" }],
      tags: ["trekking", "uttarakhand", "intermediate"],
      featured: false,
    },
    {
