...
export const adventures: Adventure[] = [
  ...
  },
  {
    ...
    bestSeason: "Jun – Sep",
    heroImage: "https://images.unsplash.com/photo-1698497077554-da44071f3966?w=1600&q=90",
    galleryImages: [],
    lat: 33.7782,
    lng: 78.6753,
      description:
  ...
  },
  {
    ...
    bestSeason: "Jul – Sep",
    heroImage: "https://images.unsplash.com/photo-1717389279143-886425f42698?w=1600&q=90",
    galleryImages: [],
    lat: 33.4427,
    lng: 76.8516,
    description:
  ...
  },
  {
    ...
    tagline: "The cold desert loop between Manali and Shimla",
    region: "Himalayas",
    state: "Himachal Pradesh",
    type: "Biking",
    difficulty: "Intermediate",
