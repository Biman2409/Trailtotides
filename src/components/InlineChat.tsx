        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2.5">
              <Compass className="w-3.5 h-3.5 text-[#f67345]" />
              <p className="text-[#f67345] text-xs font-semibold tracking-[0.22em] uppercase">
                AI Adventure Finder
              </p>
            </div>
            ...
            <div className="mt-4 w-10 h-0.5 bg-[#f67345] rounded-full" />
          </div>
        ...
        <div className="border border-white/8 rounded-2xl overflow-hidden bg-white/[0.02]">
              ...
              <div className="flex flex-wrap gap-2">
                {SUGGESTIONS.map((s) => (
                  <button
                    ...
                    className="flex items-center gap-2 text-xs border border-white/10 text-white/55 hover:text-white hover:border-[#f67345]/50 hover:bg-[#f67345]/8 px-3.5 py-2 rounded-full transition-all duration-200 tracking-wide"
                  >
                    <span>{s.icon}</span>
                    {s.label}
                  </button>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="p-3 flex-1 min-w-0">
                                ...
                                {rec?.reason && (
                                  <p className="text-[#f67345] text-xs mt-1 line-clamp-1">
                                    {rec.reason}
                                  </p>
                                )}
                              </div>
          ...
          <div className="border-t border-white/8 p-3 flex gap-3 bg-white/[0.02]">
            <input
              ...
              className="flex-1 bg-white/6 border border-white/8 text-white placeholder-white/25 text-sm px-4 py-3 rounded-xl outline-none focus:border-[#f67345]/60 focus:ring-1 focus:ring-[#f67345]/25 transition-all"
            />
            <button
              onClick={() => send()}
              disabled={!input.trim() || loading}
              className="disabled:opacity-30 disabled:cursor-not-allowed text-white px-5 py-3 rounded-xl font-semibold text-sm flex items-center gap-2 transition-all hover:-translate-y-0.5 active:translate-y-0 shadow-lg shadow-[#f67345]/20"
