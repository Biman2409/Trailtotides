      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              <div className="w-8 h-8 rounded-lg bg-[#ff6b35] flex items-center justify-center group-hover:bg-[#ff8e64] transition-colors duration-200 shadow-md shadow-[#ff6b35]/30">
            ...
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  {link.label}
                  {isActive && (
                    <span className="absolute bottom-0.5 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-[#ff6b35]" />
                  )}
                </Link>
              );
            })}
          ...
          <div className="hidden lg:flex items-center gap-3">
            {user ? (
              <div className="relative" ref={userMenuRef}>
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-[#ff6b35]/30 flex items-center justify-center text-[#ff8e64] font-semibold text-xs">
              ...
              <>
                ...
                <Link
                  href="/auth/signup"
                  className="bg-[#ff6b35] hover:bg-[#ff8e64] text-white text-sm font-semibold px-5 py-2.5 rounded-lg shadow-md shadow-[#ff6b35]/25 hover:shadow-lg hover:shadow-[#ff6b35]/30 hover:-translate-y-0.5 transition-all duration-200"
                >
                  Sign Up
                </Link>
              </>
          ...
          {navLinks.map((link) => (
            ...
            {user ? (
              <div className="pt-2 space-y-1">
                <div className="flex items-center gap-3 px-3 py-3 border-b border-white/5">
                  <div className="w-8 h-8 rounded-full bg-[#ff6b35]/30 flex items-center justify-center text-[#ff8e64] font-semibold text-sm">
                    {user.name[0].toUpperCase()}
                  </div>
                  <div>
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              >
                ...
                <Link
                  href="/auth/signup"
                  className="block w-full text-center bg-[#ff6b35] hover:bg-[#ff8e64] text-white font-semibold py-3 rounded-xl transition-colors text-sm"
                >
                  Sign Up
                </Link>
