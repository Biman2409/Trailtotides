...
export default function Footer() {
  return (
    <footer className="bg-[#05070a] text-white border-t border-white/[0.03] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[px] bg-gradient-to-r from-transparent via-[#ff5100]/20 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-32">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-20 lg:space-y-0">
              ...
              <div className="flex flex-col items-start pt-0 group">
                <Link href="/" className="flex items-center gap-4 group w-fit mb-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[#ff5100] font-black tracking-[-0.05em] text-[1.5rem] leading-none antialiased group-hover:text-white transition-colors duration-500">
                      TRAIL TO TIDES
                    </span>
          ...
          <div className="lg:col-span-5 flex flex-col lg:items-end space-y-20 lg:justify-between">
            ...
            <div className="flex flex-col lg:items-end space-y-12">
              ...
              <div className="flex flex-col lg:items-end gap-10">
                ...
                <a 
                  ...
                  className="group flex items-center gap-4 bg-white/[0.02] border border-white/[0.05] hover:border-[#ff5100]/30 px-6 py-3 rounded-2xl transition-all duration-500"
                >
        ...
        {/* Brand Bottom Bar */}
        <div className="mt-28 pt-12 border-t border-white/[0.03] flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
      ...
      {/* Background Decor */}
      <div className="absolute bottom-0 right-0 w-[45%] h-[65%] bg-[#ff5100]/[0.03] blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute top-0 left-0 w-[35%] h-[45%] bg-[#ff5100]/[0.02] blur-[120px] rounded-full pointer-events-none" />
    </footer>
  );
}
