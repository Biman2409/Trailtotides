  ...
  return (
    <footer ref={footerRef} className="bg-[#05070a] text-white border-t border-white/[0.03] overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24 lg:py-32 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[7fr_5fr] gap-24 lg:gap-32 relative z-10 items-start">
      ...
      <div className="mt-20 mb-10 flex justify-center">
        <button
          onClick={scrollToTop}
          className={`p-4 bg-white/[0.02] backdrop-blur-3xl border border-white/[0.03] rounded-full text-white/10 hover:text-[#ff5100] hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-1000 group shadow-2xl ${
