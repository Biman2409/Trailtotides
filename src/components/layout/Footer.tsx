    ...
    <footer ref={footerRef} className="bg-[#05070a] text-white border-t border-white/[0.03] overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24 lg:py-32 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#ff5100]/25 to-transparent" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-32 relative z-10 items-start">
            ...
            <div className="mt-20 mb-8 flex justify-center">
              <button
                onClick={scrollToTop}
                className={`p-3 bg-white/[0.01] backdrop-blur-3xl border border-white/[0.02] rounded-full text-white/[0.03] hover:text-[#ff5100] hover:bg-white/[0.04] hover:border-white/[0.08] transition-all duration-1000 group ${
