  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 flex flex-col gap-1.5 z-10">
        {isFeatured && (
          <div className="group/badge flex items-center gap-1.5 bg-black text-[#f67345] rounded-full px-2 py-1 shadow-md overflow-hidden transition-all duration-300 w-7 hover:w-[100px]">
        ...
        {isTTTOriginal && (
          <div className="group/badge flex items-center gap-1.5 bg-[#f67345] text-black rounded-full px-2 py-1 shadow-md overflow-hidden transition-all duration-300 w-7 hover:w-[120px]">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4">
        ...
        <h3 className="text-white font-bold text-base leading-snug mb-1.5 group-hover:text-[#f67345] transition-colors duration-200">
          {story.title}
        </h3>
        ...
        <div className="border-t border-white/10 pt-2.5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#f67345] to-[#f88c64] flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0">
          ...
          <div className="text-[#f67345] text-[10px] font-semibold group-hover:translate-x-1 transition-transform duration-200">
            Read →
          </div>
        </div>
      </div>
