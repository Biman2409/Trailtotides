    ...
    <div className="relative" ref={menuRef}>
      ...
      {open && mounted && createPortal(
        ...
        >
          ...
          <button onClick={shareInstagram} className="flex items-center justify-center w-8 h-8 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-all" title="Instagram">
            {IG_ICON}
          </button>
          <button onClick={shareX} className="flex items-center justify-center w-8 h-8 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-all" title="X">
            {X_ICON}
          </button>
          <button onClick={shareWhatsApp} className="flex items-center justify-center w-8 h-8 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-all" title="WhatsApp">
            {WA_ICON}
          </button>
