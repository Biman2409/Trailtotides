...
const categories = [
    {
      id: "land",
      label: "Land",
      icon: <Mountain className="w-6 h-6 text-[#f4845f]" />,
    ...
    items: [
      ...
      { type: "Cycling", icon: <Bike className="w-4 h-4" />, count: 27 },
      { type: "Mountaineering", icon: <Mountain className="w-4 h-4" />, count: 15 },
      { type: "Rock Climbing", icon: <Mountain className="w-4 h-4" />, count: 18 },
      { type: "Jeep Safari", icon: <Car className="w-4 h-4" />, count: 22 },
      { type: "Camel Safari", icon: <Sun className="w-4 h-4" />, count: 9 },
      { type: "Caving", icon: <HardHat className="w-4 h-4" />, count: 7 },
      { type: "Sandboarding", icon: <Sun className="w-4 h-4" />, count: 5 },
      { type: "Urban Adventure", icon: <Building2 className="w-4 h-4" />, count: 11 },
    ],
  },
  {
    id: "water",
    label: "Water",
    icon: <Waves className="w-6 h-6 text-[#6ab4f0]" />,
  ...
  },
  {
    id: "snow",
    label: "Snow",
    icon: <Snowflake className="w-6 h-6 text-[#8dcce0]" />,
