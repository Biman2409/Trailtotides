    ...
    <>
      {/* Floating button */}
        <button
          ...
          style={{ background: open ? "#d84315" : "#f4845f", boxShadow: "0 4px 20px rgba(244,132,95,0.45)", transition: "opacity 0.4s ease, transform 0.4s ease, background 0.2s" }}
        ...
        >
                      ...
                      {msg.cards.map((card, ci) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <ChevronRight className="w-4 h-4 text-white/20 group-hover:text-[#f4845f] self-center mr-2 flex-shrink-0 transition-colors" />
                          </Link>
                        );
                      })}
                    </div>
          ...
          <div className="border-t border-white/8 p-3 flex gap-2 bg-white/[0.02]">
            <input
              ...
              className="flex-1 bg-white/6 border border-white/8 text-white placeholder-white/25 text-sm px-3.5 py-2.5 rounded-xl outline-none focus:border-[#f4845f]/60 focus:ring-1 focus:ring-[#f4845f]/25 transition-all"
            />
            <button
              onClick={send}
