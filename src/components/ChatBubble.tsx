  ...
  return (
    <>
      {/* Floating button */}
          <button
            onClick={() => setOpen((v) => !v)}
            className={`fixed bottom-6 right-6 z-50 flex items-center justify-center text-white w-14 h-14 rounded-full shadow-xl transition-all duration-500 ease-out hover:scale-110 hover:shadow-2xl active:scale-95 ${visible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-12 scale-50 pointer-events-none"}`}
            style={{ background: "#ff5100", boxShadow: "0 4px 25px rgba(255,81,0,0.5)", transition: "opacity 0.5s ease, transform 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275), background 0.2s" }}
